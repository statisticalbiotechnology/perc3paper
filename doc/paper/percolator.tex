...
the protein's peptide inferences came from incorrect PSMs, 
...
\caption{\label{fig:shared-accuracy}\textbf{Retaining shared peptides
  ...
  entrapment proteins in the set of identified target proteins, the
...
% FIXME: Make the B panel a true log-log, e.g. it should spell 10^-3
% rather than -3. --Lukas
\end{center}
\end{figure}
...
%%   the number of true inferences, against the observed entrapment
